...
class BootGenerator extends BasicGenerator {
  _prompting() {
    const prompts = [
      {
        name: 'name',
  ...
  async _writing() {
    ...
    if (pkg['create-template']) {
      ...
      delete projectPkg['create-template'].ignoreScript;
      delete projectPkg['create-template'].ignoreDevDependencies;
      delete projectPkg['create-template'].ignore;
